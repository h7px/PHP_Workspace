...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['confirm_approve'])) {
    try {
        ...
        $meldung = "Fehler beim Bestätigen des Highscores: " . $e->getMessage();
    }
}
...
<head>
    ...
    <title>Highscore bestätigen - Bestätigung</title>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h2 class="text-center mb-0">Highscore bestätigen</h2>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="alert alert-warning" role="alert">
                            Möchten Sie den folgenden Highscore wirklich bestätigen?
                        </div>
